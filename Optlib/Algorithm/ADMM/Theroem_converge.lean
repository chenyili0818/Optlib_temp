...
import Optlib.Algorithm.ADMM.Image_subgradient_closed
...
lemma Iskktpair [Setting E₁ E₂ F admm admm_kkt] : Convex_KKT x₁'' x₂'' y'' admm.toOpt_problem :=
   {
...
theorem ADMM_convergence [Setting E₁ E₂ F admm (admm_kkt₁ fullrank₁ fullrank₂ (admm_kkt := admm_kkt) (_s := ⟨⟩))]:
      ∃ ( _x₁   : E₁) ( _x₂ : E₂) ( _y : F) , Convex_KKT _x₁ _x₂ _y admm.toOpt_problem
